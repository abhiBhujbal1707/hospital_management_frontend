...
const Signup = ({ userType }) => {
    ...
    return (
        <div className="bg-blur backdrop-blur-xs min-h-screen flex items-center justify-center py-10 px-4">
            <div className="bg-white bg-opacity-80 p-6 rounded-lg shadow-lg max-w-lg w-full">
                <h1 className="text-2xl font-semibold text-center mb-6">{userType} Sign In Form</h1>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input 
                                ...
                                className="mt-2 w-full border border-gray-300 rounded-lg shadow-sm p-2 focus:ring-blue-500 focus:border-blue-500"
                            />
                    ...
                    <button 
                        type="submit" 
                        className="w-full bg-blue-600 text-white py-3 mt-4 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-300 focus:ring-opacity-50"
                    >
                        Sign Up
                    </button>
                </form>
